...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    >
      ...
      /> */}
      {/* <h4 className="text-5xl sm:text-3xl font-bold text-gray-800 dark:text-white text-center">
        🤖 FlexGPT
      </h4> */}
      <h4 className="text-5xl sm:text-3xl font-bold text-gray-800 dark:text-white text-center flex items-center justify-center gap-2">
        <img
          src={assets.logo} 
          alt="FlexGPT Logo"
          className="w-10 h-10"
      ...
      >
        ...
        <div className="flex flex-col text-sm">
          ...
          <p className="text-xs text-gray-400">
            Purchase credits to use flexgpt
          </p>
        </div>
      </div>
